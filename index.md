...
這個一對一諮詢，我不要準備好的解答，我要的是能做出這個解答的能力。我還欠缺什麼經驗或能力? 要如何成長? 練習什麼東西? 如何自我迭代改進? 還是我要磨練對什麼事物做逆向工程的練習?  
我要的是隱性智慧，怎麼做到賺錢的隱性智慧。我不要google可以搜到的表性知識，比如大師班Day2 AI的操作和prompt就屬於能搜到的表性知識。
...
1. 要如何快速迭代?  
   怎麼找到一個可以把產品快速迭代的方法?
2. 粉專經營基本上是從零開始，似乎是目前的困境?  
   身為100%I型的人格，完全內向型厭惡與人交流，不要說國中高中同學沒有聯絡，我連大學同學都沒有聯絡。離職這件事家人不能接受，也順手斷絕聯繫。  
3. 我所會的東西似乎剛好沒有TA交集?  
    * 據我所知
      * 男生很少會想要學多重才藝，而且很多工程師平時喜歡看的訊息是股票報名牌而不是投資思維。  
      * 女生學多重才藝的比例比較高，也比較少接觸心智韌性，因為心智韌性往往是在競技上才會用到。  
    * 分開看變成兩邊不討好，因為我不同的領域雖然都在入門以上，但是都專業未滿。一般人學習還是直觀會去找那個領域深耕的專家。
    * 心智韌性相比於在一輩子在競技場上的人，我的經驗也不是專業，更不用說大部分的人其實不了解這是什麼。 所以我在行銷上首先要先宣揚心智韌性的重要性?
...
* [鍊金Mage](https://alchemy.posetmage.com) - 現階段主要在經營的品牌
  ...
  * [用來發社群的文章](https://alchemy.posetmage.com/Daily/)，從這邊的文章改文發去其他平台(FB, twitter, threads......)
* 其他品牌線：
  * LatticeMage
...
這也是樣樣通樣樣鬆的主因，並沒有特別喜歡某件事情，沒內在動機。比如現在學畫畫也只是為了在AI時代因應"使用AI好的人往往也是具備domain knowledge的人"；但我現在並不喜歡畫畫，甚至討厭畫畫了。  
...
### 輸入輸出比
初學者是需要臨摹或模仿，輸入輸出比可能是一比一，學了一些之後嘗試一小點輸出；入門到一定程度之後，可能是看許多輸入，產生一個自己的輸出，輸入輸出比可能是十比一，產生一次都很花時間；過了一個門檻之後，會是可以輸入輸出比一比五之類的。  
這樣觀察我遊戲製作可能還只是入門以上，但文字生產目前已經到了可以用比較少的輸入換取比較大的輸出量。 

## 總結
我認為我的基底的是足夠的，已經有基本的商業思維，也有深厚的知識儲備來製作產品。方向也調整到能符合大眾需求：個人身心成長、健康、財務、(不做人際方向)
