...
去年剛離職到現在做遊戲速度太慢，相比於其他indie製作者速度，我製作的速度遠遠不夠。
而真正讓我感受到迭代速度重要性是我朋友找我做量化交易，因為我們都有足夠的理解，這段期間我們的策略在短時間做了大量的迭代，而且僅僅是每天開會一小時過程寫程式，速度就超過我遊戲製作的速度，由此體認到目前我的程度是不能用遊戲創業的。
...
也就現在是絕大多數時間，可以專注在處理文字本身，這個速度才是合格的效率。所以是為了整合進我的markdown生產流程，才會選用這整套架站解方。  
